...
class XNLIProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir, binary_pred, inference=False):
        ...
        if not inference:
            return self._create_examples(
               os.path.join(data_dir, "TOEFL_bert_test.txt"), "test", binary_pred, inference)
        else:
            return self._create_examples(
               os.path.join(data_dir, "TOEFL_bert_inference.txt"), "test_inference", binary_pred, inference)
    def get_labels(self):
        """See base class."""
